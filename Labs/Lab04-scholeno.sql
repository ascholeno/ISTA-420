...
where o.orderdate = (select max(orderdate) from sales.orders) order by o.orderid desc;
...
select o.orderdate from sales.orders o; --Look at the order dates
select o.orderdate, o.empid from sales.orders o where o.orderdate >= '2016-05-01'; -- narrow our order dates 
select o.empid from sales.orders o where o.orderdate >= '2016-05-01'; --select empid -- Turn it into a list instead of a table
select distinct o.empid from sales.orders o where o.orderdate >= '2016-05-01'; --Make empid distinct (not necessary) 
select distinct o.empid from sales.orders o where o.orderdate >= '2016-05-01'; --
select e.empid, e.firstname, e.lastname from hr.employees e; -- Outer query
--------------------------------------------------------------------------------------------------------------------
